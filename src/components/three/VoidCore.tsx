    ...
    <group ref={groupRef}>
      <mesh ref={sphereRef}>
        ...
        <meshStandardMaterial
          ...
          emissiveIntensity={overdrive ? 2.6 : 1.25}
          roughness={0.28}
          metalness={0.85}
        />
      </mesh>
      ...
      <mesh ref={ringARef} rotation={[Math.PI / 2.35, 0, 0]}>
        <torusGeometry args={[1.88, 0.025, 16, 160]} />
      ...
      <mesh rotation={[1.1, 0.4, 0.7]}>
        <torusGeometry args={[2.75, 0.011, 12, 180]} />
        <meshBasicMaterial color="#fb2c36" transparent opacity={overdrive ? 0.72 : 0.38} blending={AdditiveBlending} />
      </mesh>

      <Sparkles count={overdrive ? 120 : 64} scale={5.8} size={overdrive ? 4 : 2.6} speed={overdrive ? 1.8 : 0.6} color={overdrive ? '#22d3ee' : '#8b5cf6'} />
    </group>
  )
}
