...
export function NeonButton({
  ...
  return (
    <motion.button
      ...
      className={cn(
        'glitch-hover group relative overflow-hidden border px-5 py-3 text-xs font-black uppercase tracking-[0.24em] transition hud-corners',
        ...
        variant === 'primary' && 'border-cyan-300/45 bg-cyan-300/10 text-cyan-100 shadow-[0_0_32px_rgba(34,211,238,0.28),0_0_54px_rgba(236,72,153,0.12)] hover:border-cyan-200',
